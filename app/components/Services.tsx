      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, idx) => (
            ...
            >
              <div className="group bg-black/50 backdrop-blur-sm border border-zinc-800 rounded-2xl p-8 hover:border-amber-400 transition-all transform hover:-translate-y-4 hover:shadow-2xl hover:shadow-amber-500/20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-amber-400 mb-4 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 inline-block">
                    {service.icon}
                  </div>
