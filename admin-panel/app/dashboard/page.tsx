    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      >
        <div className="p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8">PFC Films Admin</h2>
          ...
          <button
            ...
            className="w-full flex items-center space-x-2 sm:space-x-3 px-3 sm:px-4 py-2 sm:py-3 rounded-lg hover:bg-red-600 mt-6 sm:mt-8 text-sm sm:text-base"
          >
      ...
      <div className="lg:pl-64">
        ...
        <header className="bg-white border-b border-zinc-200 sticky top-0 z-40">
          <div className="px-4 py-3 sm:py-4 flex items-center justify-between">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-zinc-900 capitalize">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-zinc-200">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl sm:text-3xl font-bold text-zinc-900 mt-2">
                          {stats?.productions || 0}
                        </p>
                      </div>
                      <Film className="w-10 h-10 sm:w-12 sm:h-12 text-amber-500" />
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-zinc-200">
                    <div className="flex items-center justify-between">
                      ...
                      <Image className="w-10 h-10 sm:w-12 sm:h-12 text-amber-500" />
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-zinc-200">
                    <div className="flex items-center justify-between">
                      ...
                      <Mail className="w-10 h-10 sm:w-12 sm:h-12 text-amber-500" />
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-zinc-200">
                    <div className="flex items-center justify-between">
                      ...
                      <MessageSquare className="w-10 h-10 sm:w-12 sm:h-12 text-amber-500" />
                    </div>
                  </div>
